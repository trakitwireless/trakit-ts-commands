import { email, guid, JsonObject, nothing, Place, ulong } from "@trakit/objects";
...
export class RepPlaceListByCompany extends RepPlaceList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, Place], index: number): boolean {
