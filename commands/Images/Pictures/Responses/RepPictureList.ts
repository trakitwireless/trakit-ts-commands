import { email, guid, JsonObject, nothing, Picture, ulong } from "@trakit/objects";
...
export class RepPictureListByCompany extends RepPictureList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, Picture], index: number): boolean {
