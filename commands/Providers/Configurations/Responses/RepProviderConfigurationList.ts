import { email, guid, JsonObject, nothing, ProviderConfiguration, ulong } from "@trakit/objects";
...
export abstract class RepProviderConfigurationList extends ReplySyncList<ProviderConfiguration> {
	...
	override getCollection() { return this.providerConfigurations as ProviderConfiguration[]; }
}
...
export class RepProviderConfigurationListByCompany extends RepProviderConfigurationList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, ProviderConfiguration], index: number): boolean {
