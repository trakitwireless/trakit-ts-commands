import { email, guid, JsonObject, nothing, ProviderScript, ulong } from "@trakit/objects";
...
export class RepProviderScriptListByCompany extends RepProviderScriptList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, ProviderScript], index: number): boolean {
