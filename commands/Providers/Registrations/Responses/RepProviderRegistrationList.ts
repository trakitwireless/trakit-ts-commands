...
export abstract class RepProviderRegistrationList extends ReplySyncList<ProviderRegistration> {
	...
	override getList() { return this.providerRegistrations as ProviderRegistration[]; }
}
...
export class RepProviderRegistrationListByCompany extends RepProviderRegistrationList {
	...
	override _filterCollection(pair: [ulong | guid | email | codified | string, ProviderRegistration], index: number): boolean {
