import { CompanyReseller, email, guid, JsonObject, nothing, ulong } from "@trakit/objects";
...
export class RepCompanyResellerListByCompany extends RepCompanyResellerList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, CompanyReseller], index: number): boolean {
