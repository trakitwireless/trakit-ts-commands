import { email, guid, JsonObject, MaintenanceJob, nothing, ulong } from "@trakit/objects";
...
export class RepMaintenanceJobListByCompany extends RepMaintenanceJobList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, MaintenanceJob], index: number): boolean {
