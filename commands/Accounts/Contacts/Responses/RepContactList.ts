import { Contact, email, guid, JsonObject, nothing, ulong } from "@trakit/objects";
...
export class RepContactListByCompany extends RepContactList {
	...
	override _filterCollection(pair: [string | guid | email | ulong, Contact], index: number): boolean {
