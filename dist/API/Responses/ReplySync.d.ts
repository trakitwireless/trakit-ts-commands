import { JsonObject, SyncName, ulong } from '@trakit/objects';
 ...
 */
export declare abstract class ReplySync extends Reply implements IContentCompany {
    /**
...
//# sourceMappingURL=ReplySync.d.ts.map