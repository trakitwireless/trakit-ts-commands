 ...
 */
export declare abstract class PayUserAdvancedList extends Payload implements IPayDeletable {
    /**
 ...
 */
export declare class PayUserAdvancedListByCompany extends PayUserAdvancedList implements IPayListByCompany {
    /**
