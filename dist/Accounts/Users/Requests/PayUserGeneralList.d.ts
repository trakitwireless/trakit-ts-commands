 ...
 */
export declare abstract class PayUserGeneralList extends Payload implements IPayDeletable {
    /**
 ...
 */
export declare class PayUserGeneralListByCompany extends PayUserGeneralList implements IPayListByCompany {
    /**
