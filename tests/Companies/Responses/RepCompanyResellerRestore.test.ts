...
import { RepCompanyResellerRestore } from "../../../commands/Companies/Responses/RepCompanyResellerRestore";

describe('RepCompanyResellerRestore', () => {
	it('should create instance with empty constructor', () => {
		const reply = new RepCompanyResellerRestore();
	...
	it('should create instance with JSON data', () => {
		...
		const reply = new RepCompanyResellerRestore(json);
	...
	it('should return correct action metadata', () => {
		const reply = new RepCompanyResellerRestore();
		expect(reply.action()).toBe("Company.ResellerRestore");
		expect(reply.actionShort()).toBe("CompanyResellerRestore");
		expect(reply.actionNormalized()).toBe("company_reseller_restore");
	});
});
