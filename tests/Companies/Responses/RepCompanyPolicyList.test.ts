...
import { RepCompanyPolicyListAll } from "../../../commands/Companies/Responses/RepCompanyPolicyList";

describe('RepCompanyPolicyListAll', () => {
	it('should create instance with empty constructor', () => {
		const reply = new RepCompanyPolicyListAll();
	...
	it('should create instance with JSON data', () => {
		...
		const reply = new RepCompanyPolicyListAll(json);
	...
	it('should return correct action metadata', () => {
		const reply = new RepCompanyPolicyListAll();
		expect(reply.action()).toBe("Company.PolicyList");
		expect(reply.actionShort()).toBe("CompanyPolicyList");
		expect(reply.actionNormalized()).toBe("company_policy_list");
	});
});
