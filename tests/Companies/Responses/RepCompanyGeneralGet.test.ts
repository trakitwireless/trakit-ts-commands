...
describe('RepCompanyGeneralGet', () => {
	it('should create instance with empty constructor', () => {
		const reply = new RepCompanyGeneralGet();
	...
	it('should create instance with JSON data', () => {
		...
		const reply = new RepCompanyGeneralGet(json);
	...
	it('should return correct action metadata', () => {
		const reply = new RepCompanyGeneralGet();
		expect(reply.action()).toBe("Company.GeneralGet");
		expect(reply.actionShort()).toBe("CompanyGeneralGet");
		expect(reply.actionNormalized()).toBe("company_general_get");
	});
});
