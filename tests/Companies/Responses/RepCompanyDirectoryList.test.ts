...
import { RepCompanyDirectoryListAll } from "../../../src/Companies/Responses/RepCompanyDirectoryList";

describe('RepCompanyDirectoryListAll', () => {
	it('should create instance with empty constructor', () => {
		const reply = new RepCompanyDirectoryListAll();
	...
	it('should create instance with JSON data', () => {
		...
		const reply = new RepCompanyDirectoryListAll(json);
	...
	it('should return correct action metadata', () => {
		const reply = new RepCompanyDirectoryListAll();
		expect(reply.action()).toBe("Company.DirectoryList");
		expect(reply.actionShort()).toBe("CompanyDirectoryList");
		expect(reply.actionNormalized()).toBe("company_directory_list");
	});
});
