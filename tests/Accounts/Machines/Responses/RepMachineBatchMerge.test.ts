...
describe("RepMachineBatchMerge", () => {
	test("constructor creates instance with machines", () => {
		...
		const reply = new RepMachineBatchMerge({ machines: [machine1, machine2] });
	...
	test("constructor creates instance with JSON", () => {
		const reply = new RepMachineBatchMerge({
			machines: [
	...
	test("toJSON returns correct structure", () => {
		...
		const reply = new RepMachineBatchMerge({ machines: [machine] });
