...
import { RepDispatchTaskMerge } from "../../../../src/Dispatch/DispatchTask/Responses/RepDispatchTaskMerge";

describe('RepDispatchTaskMerge', () => {
	it('should create instance with empty constructor', () => {
		const reply = new RepDispatchTaskMerge();
	...
	it('should create instance with JSON data', () => {
		...
		const reply = new RepDispatchTaskMerge(json);
	...
	it('should return correct action metadata', () => {
		const reply = new RepDispatchTaskMerge();
		expect(reply.action()).toBe("DispatchTask.Merge");
		expect(reply.actionShort()).toBe("DispatchTaskMerge");
		expect(reply.actionNormalized()).toBe("dispatch_task_merge");
	});
});
