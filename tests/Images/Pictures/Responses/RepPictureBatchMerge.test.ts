...
describe("RepPictureBatchMerge", () => {
	test("constructor creates instance with pictures", () => {
		...
		const reply = new RepPictureBatchMerge({ pictures: [picture1, picture2] });
	...
	test("constructor creates instance with JSON", () => {
		const reply = new RepPictureBatchMerge({
			pictures: [
	...
	test("toJSON returns correct structure", () => {
		...
		const reply = new RepPictureBatchMerge({ pictures: [picture] });
